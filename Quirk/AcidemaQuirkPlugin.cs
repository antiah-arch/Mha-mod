...
namespace AcidemaQuirkMod
{
    ...
    [HarmonyPatch(typeof(Actor), nameof(Actor.addActorTrait))]
    ...
    [HarmonyPatch(typeof(Actor), nameof(Actor.removeTrait))]
    ...
    [HarmonyPatch(typeof(Actor), nameof(Actor.updateStatus))]
    ...
    [HarmonyPatch(typeof(Actor), nameof(Actor.unitDied))]
